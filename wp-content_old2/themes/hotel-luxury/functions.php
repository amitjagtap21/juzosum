...
// Set UI labels for Custom Post Type
    $labels = array(
        'name'                => _x( 'Places', 'Post Type General Name', 'hotel-luxury' ),
        'singular_name'       => _x( 'Place', 'Post Type Singular Name', 'hotel-luxury' ),
        'menu_name'           => __( 'Places', 'hotel-luxury' ),
        'name_admin_bar'        => __( 'Places', 'hotel-luxury' ),
        'parent_item_colon'   => __( 'Parent Places', 'hotel-luxury' ),
        'all_items'           => __( 'All Places', 'hotel-luxury' ),
        'view_item'           => __( 'View Places', 'hotel-luxury' ),
        'add_new_item'        => __( 'Add New Place', 'hotel-luxury' ),
        'add_new'             => __( 'Add New', 'hotel-luxury' ),
        'edit_item'           => __( 'Edit Place', 'hotel-luxury' ),
        'update_item'         => __( 'Update Place', 'hotel-luxury' ),
        'search_items'        => __( 'Search Place', 'hotel-luxury' ),
        'not_found'           => __( 'Not Found', 'hotel-luxury' ),
        'not_found_in_trash'  => __( 'Not found in Trash', 'hotel-luxury' ),
        'featured_image'        => __( 'Featured Image', 'hotel-luxury' ),
	'set_featured_image'    => __( 'Set featured image', 'hotel-luxury' ),
	'remove_featured_image' => __( 'Remove featured image', 'hotel-luxury' ),
	'use_featured_image'    => __( 'Use as featured image', 'hotel-luxury' ),
	'insert_into_item'      => __( 'Insert into item', 'hotel-luxury' ),
	'uploaded_to_this_item' => __( 'Uploaded to this item', 'hotel-luxury' ),
	'items_list'            => __( 'Items list', 'hotel-luxury' ),
	'items_list_navigation' => __( 'Items list navigation', 'hotel-luxury' ),
	'filter_items_list'     => __( 'Filter items list', 'hotel-luxury' ),
    );
     
// Set other options for Custom Post Type
     
    $args = array(
        'label'               => __( 'places', 'hotel-luxury' ),
        'description'         => __( 'Places news and reviews', 'hotel-luxury' ),
        'labels'              => $labels,
